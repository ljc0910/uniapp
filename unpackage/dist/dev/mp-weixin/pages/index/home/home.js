...
/* harmony import */ var _home_vue_vue_type_template_id_73cf3aae___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home.vue?vue&type=template&id=73cf3aae& */ 53);
...
/* harmony import */ var _home_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home.vue?vue&type=style&index=0&lang=scss& */ 61);
...
var render = function() {
  ...
  var m0 = __webpack_require__(/*! ../../../static/img/fangdajing.png */ 55)

  var m1 = __webpack_require__(/*! ../../../static/img/location.png */ 56)

  var m2 = __webpack_require__(/*! ../../../static/img/trangle.png */ 57)
...
var _area = _interopRequireDefault(__webpack_require__(/*! ../../../static/js/area */ 60));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var homeTab = function homeTab() {Promise.all(/*! require.ensure | pages/index/home/homeTab/homeTab */[__webpack_require__.e("common/vendor"), __webpack_require__.e("pages/index/home/homeTab/homeTab")]).then((function () {return resolve(__webpack_require__(/*! ./homeTab/homeTab */ 87));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { homeTab: homeTab }, data: function data() {return { swiperList: 5, autoplay: true, interval: 2000, duration: 500, current: 2, value: "", sheetShow: false, areajs: _area.default, searchVal: "", curLocation: "未知", //用户的地址
      searchIsTop: false };}, onLoad: function onLoad() {// uni.login({
    //   provider: "weixin",
    ...
    //   }
    // });
  }, methods: { currentChange: function currentChange(event) {this.current = event.detail.current;}, searchValChange: function searchValChange(val) {console.log(val);}, // 手动定位
